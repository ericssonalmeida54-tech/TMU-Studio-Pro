...
// Sources aligned with International MTM Directorate / KSU Standards

export const REACH_BASE: Record<number, number[]> = {
  // Dist(cm): [A, B, C/D, E, (Placeholders if needed)]
  // Note: C and D are often grouped. E is Type E.
  // Order here: A, B, C/D, E
  // Using 5 elements to match original structure but index 2 and 3 might be same for C/D
  2:  [2.0, 2.0, 2.0, 2.0, 1.6],
  4:  [3.4, 3.8, 5.2, 5.2, 3.0], // Corrected B from 3.4 to 3.8
  6:  [4.3, 5.3, 6.5, 6.5, 3.8], // Corrected B from 4.3 to 5.3
  8:  [5.1, 6.5, 7.8, 7.8, 4.5], // Corrected B from 5.1 to 6.5
  10: [6.1, 7.9, 9.1, 9.1, 5.3], // Corrected B from 6.3 to 7.9
  12: [6.4, 8.7, 10.0, 10.0, 6.1],
  14: [6.9, 9.6, 10.9, 10.9, 6.7],
  16: [7.3, 10.5, 11.9, 11.9, 7.3],
  18: [7.7, 11.4, 12.8, 12.8, 7.9],
  20: [8.1, 12.3, 13.7, 13.7, 8.5],
  22: [8.5, 13.2, 14.6, 14.6, 9.1],
  24: [8.9, 14.1, 15.5, 15.5, 9.7],
  26: [9.3, 15.0, 16.4, 16.4, 10.3],
  28: [9.7, 15.9, 17.3, 17.3, 10.9],
  30: [10.1, 16.7, 18.2, 18.2, 11.5], // Corrected B, C
  35: [11.1, 18.2, 19.9, 19.9, 13.0],
  40: [12.1, 20.3, 22.1, 22.1, 14.4],
  45: [13.1, 22.0, 23.9, 23.9, 15.8],
  50: [14.1, 23.7, 25.7, 25.7, 17.2],
  55: [15.1, 25.4, 27.5, 27.5, 18.6],
  60: [16.1, 27.1, 29.3, 29.3, 20.0],
  65: [17.1, 28.8, 31.1, 31.1, 21.4],
  70: [18.1, 30.5, 32.9, 32.9, 22.8],
  75: [19.1, 32.2, 34.7, 34.7, 24.2],
  80: [20.1, 33.9, 36.5, 36.5, 25.6]
};

export const MOVE_BASE: Record<number, number[]> = {
  // Dist(cm): [A, B, C] (B is approximate/uncertain, C is exact)
  2:  [2.0, 2.0, 2.0],
  4:  [3.1, 3.8, 4.3],
  6:  [4.1, 5.3, 5.5],
  8:  [5.1, 6.5, 6.7],
